...
function controllerVariation(h, tag, props) {
  return h(tag, {
    props: _Object$assign({}, props, {
      key: props.value || _Number$isInteger(props.value) || typeof props.value === 'boolean' ? props.value : props.label,
      label: props.value || _Number$isInteger(props.value) || typeof props.value === 'boolean' ? props.value : props.label
    })
  }, props.label);
}
...
//# sourceMappingURL=mixin-package-option.js.map